...
def main(arglist):
    ...
    for row in range(1, sheet.nrows):
        ...
        # If copyright holder is in contribs, add 245 ending punctuation
        # Otherwise add $c with all other contributors
        if 'producer' in contribs[i]: # copyright holder
